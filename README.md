...
## Business Problem
Financial institutins reeive thousands of customers complaints. Understanding the nature of these complaints helps improve products, services, and customer experience.
...
## Recommendations
- The management should find out what those states with low number of complaints are doing right, what strategies are they using to minimize the number of complaints and train the members of staff of the states where most or high number of complaints are received.
- The management should review and redesign the operational process of those products that generated the highest number of complaints by simplifying the operational process further for the customers of these products. This will remove a lot of bootlenecks that made it difficult to access the products.
